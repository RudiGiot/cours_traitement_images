# Une introduction au traitement d'images {.unnumbered}
...
![](images_dans_le_cours/cover_lena.png)
...
* **L'implémentation Python :** Du code basé sur les standards de l'industrie (`OpenCV`, `NumPy`, ...).
* **Des exercices de base :** Une application modulaire en code Python des principes mathématiques et algorithmiques.
...
4. Un clone du repo https://github.com/RudiGiot/cours_traitement_images.git pour pouvoir agrémenter mon cours avec vos notes et vos codes.
:::