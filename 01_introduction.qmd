...
Figure 1 : Dispersion de la lumière dans le prisme de Newton
...
#### 2. Le modèle HSL (TSL : Teinte, Saturation, Luminosité)
...
#### 3. Le modèle CIE (au lieu de ICL)
...
## 4. Création et manipulation d'une image en Python
...
## 5. La bibliothèque OpenCV : le standard industriel
...
## 7. Exercices de programmation : Création d'images matricielles
