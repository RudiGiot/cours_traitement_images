...
![Diagrammes de chromaticité uniformes de la CIE (1960 et 1976).](images_dans_le_cours/chromacite.jpeg){#fig-cie-uniforme width="80%" fig-align="center"}
...
![Ellipses de McAdam.](images_dans_le_cours/mcadam.jpeg){#fig-mcadam width="80%" fig-align="center"}
...
![Couleurs naturelles.](images_dans_le_cours/naturelles.jpeg){#fig-naturelles width="80%" fig-align="center"}
...
En utilisant uniquement numpy, créez une image de 300 pixels de haut sur 300 pixels de large représentant le drapeau de la Belgique (trois bandes verticales de largeur égale : Noir, Jaune, Rouge). Sauvegardez-la sous le nom `drapeau.png` (vous pouvez utiliser opencv pour la sauvegarde).
:::

::: {.callout-note icon="false"}
### Exercice 2 : Les 4 quadrants
En utilisant uniquement numpy, créez une image carrée de 400x400 pixels, divisée en 4 carrés égaux (200x200). 
...
En utilisant uniquement numpy, créez une image de 500x500 pixels. Le fond de l'image doit être jaune pur, mais elle doit posséder une bordure bleue épaisse de 20 pixels sur tout son périmètre. 
...
En utilisant uniquement numpy, créez une image de 256 pixels de haut sur 256 pixels de large. 
